=== Geazen Plugin ===
Contributors: geazen
Tags: affiliation,marketing,ads,advertising,affiliate,links,product feed,data feed,XML,commerce,ecommerce,products,earn money,revenue,geazen
...
1. Upload the zip content to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Enter your Geazen username and password, test the connection and save 
4. If you wish you can customize the HTML link/product template
5. Now you just need to write your first affiliate post! :)

Sigues estos pasos:

1. Sube el contenido del zip en el directorio `/wp-content/plugins/`
2. Activa el plugin a través del menú 'Plugins' de WordPress
3. Introduce tu usuario y contraseña de Geazen, prueba la conexión y graba
4. Sí lo deseas puedes modificar el template HTML para los enlaces/productos
5. Escribe tu primer post de afiliado! :)
...
= El plugin no encuentra ningún enlace para mis textos =

Probablemente no exista ningún enlace para ese texto, trata de utilizar palabras más genéricas o los nombres de marcas y productos de programas de Geazen.
Aquí tienes una [lista de los actuales](http://www.geazen.es/programas).

= El plugin me muestra una lista de enlaces y productos pero no me permite insertarlos, están deshabilitados =

Se trata de enlaces a programas para los que aún no estás aceptado en la red de afiliación. Para poder trabajar con ellos debes ser aceptado.
Entra en tu panel de afiliado de Geazen y solicita aquellos que necesites.
